...
class GeneratorDCGAN_Upsample(nn.Module):

    def __init__(self, config):

        super(GeneratorDCGAN_Upsample, self).__init__()
        ...
        for i in range(conv_number - 1):
            ...
            conv_t_block = ConvUpsampleBlock(in_channels=in_channels, out_channels=out_channels)
        ...
        self.upsample = nn.UpsamplingNearest2d(scale_factor=2)
        self.conv_last = nn.Conv2d(in_channels=in_channels,
